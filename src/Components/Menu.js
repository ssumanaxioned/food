      ...
      <div className="wrapper">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="basis-full md:basis-[45%] space-y-4">
            <span className='font-bold text-secondary-200 text-2xl xl:text-3xl'>The Pizza Menu</span>
            <h5 className='font-bold text-secondary-300 text-3xl xl:text-4xl'>CHICAGO THIN CRUST</h5>
